...
def generate_discover(current_chart):
    try:
        ...
        song = Chart_disc.objects.get(title=current_chart['title'], tags=current_chart['tags'],
                                      country=current_chart['country'], today=current_chart['date'])
        ...
        try:
            previous_entry = Chart_disc.objects.get(title=current_chart['title'], tags=current_chart['tags'],
                                                    country=current_chart['country'], today=yesterday)
        ...
        try:
            last_week_entry = Chart_disc.objects.get(title=current_chart['title'], tags=current_chart['tags'],
                                                     country=current_chart['country'], today=last_week)
